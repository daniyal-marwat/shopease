...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="max-w-sm md:ml-24 px-4 py-8 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4 md:ml-24">
          <motion.div
            key={active}
            initial={{
              y: 20,
